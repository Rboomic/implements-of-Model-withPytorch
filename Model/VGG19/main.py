...
class VGG19(tnn.Module):
    def __init__(self, n_classes=N_CLASSES):
        ...
        self.layer8 = conv_layer(256, 256, 3, 1)
        self.pool3 = tnn.MaxPool2d(kernel_size=2, stride=2)

        self.layer9 = conv_layer(256, 512, 3, 1)
        ...
        self.layer14 = conv_layer(512, 512, 3, 1)
        self.layer15 = conv_layer(512, 512, 3, 1)
        self.layer16 = conv_layer(512, 512, 3, 1)
